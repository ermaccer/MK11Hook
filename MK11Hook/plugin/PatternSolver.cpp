...
void PatternSolver::Initialize()
{
    ...
    ms_patterns[PATID_FightStartupQueueModifiers] = GetPattern("48 8B C4 55 41 54 41 55 41 56 41 57 48 8B EC 48 81 EC ? ? ? ? 48 C7 45 ? ? ? ? ? 48 89 58 10 48 89 70 18 48 89 78 20 48 8B FA", 0);
